<template>
  <div class="flex flex-col items-center border-b bg-white py-3 mt-2 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
    <a href="#" class="text-2xl font-bold text-gray-800">Vinn Shop</a>
  ...
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div class="px-4 pt-8">
      ...
      <form class="mt-5 grid gap-6">
        <div class="relative">
          <input class="peer hidden" id="radio_3" type="radio" value="Cash Or Delivery" v-model="paymentType" />
          <span
            class="peer-checked:border-gray-700 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
          <label
            class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4"
            ...
            <img class="w-14 object-contain"
              ...
              alt="" />
            <div class="ml-5 mt-4">
              <span class="mt-2 font-semibold">Cash Or Delivery</span>
              <!-- <p class="text-slate-500 text-sm leading-6">Delivery: 2-4 Days</p> -->
            </div>
          </label>
        </div>
