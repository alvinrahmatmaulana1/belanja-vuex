...
<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  ...
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div class="">
      <label for="email" class="mt-4 mb-2 block text-sm font-medium">Nama</label>
      <div class="relative">
        <input type="text" id="email" name="email" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Masukan Nama" />
