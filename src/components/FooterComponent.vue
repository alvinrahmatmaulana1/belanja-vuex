            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-4 lg:py-4">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-yellow-400 sm:text-center dark:text-gray-400">© 2023 <a
                            href="https://flowbite.com/" class="hover:underline">Vinn Store</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <a href="https://github.com/alvinrahmatmaulana1"
                        ...
                        <a href="https://www.instagram.com/alvinrahmat_99/"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://wa.me/6285316195228"
                            class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="currentColor"
